    ...
    <>
      ...
      <footer className="relative z-10 py-12 px-6 flex flex-col md:flex-row justify-between items-center gap-6 text-[#94a3b8] text-sm font-semibold border-t border-white/30"
        ...
        <div className="flex items-center gap-6">
          <motion.a whileHover={{ color: "#6c5ce7", scale: 1.05 }} href="/policies" className="hover:underline transition-all">Privacy Policy</motion.a>
          <motion.a whileHover={{ color: "#6c5ce7", scale: 1.05 }} href="/policies" className="hover:underline transition-all">Terms of Service</motion.a>
          <motion.a whileHover={{ color: "#00d4ff", scale: 1.05 }} href="/policies" className="hover:underline transition-all">Disclaimer</motion.a>
        </div>
      </footer>
